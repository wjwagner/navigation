...
bool LatchedStopRotateController::rotateToGoal(
  ...
  double ang_diff = angles::shortest_angular_distance(yaw, goal_th);
    ...
    // v1 = v0 + a * dt
    double max_acc_vel = vel_yaw_lim + acc_lim[2] * sim_period;
    double min_acc_vel = vel_yaw_lim - acc_lim[2] * sim_period;
    ...
    double max_speed_to_stop = sign(ang_diff)*sqrt(2 * acc_lim[2] * fabs(ang_diff));
    ...
    // Enforce user defined velocity limits.
